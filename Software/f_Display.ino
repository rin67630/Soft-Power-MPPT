...
//    display.drawString(0, 24, "Curr  ="+String(dashboard.Ibat) +"A");
    ...
    {
      display.drawString(0, 48, "Efficiency: ");
      sprintf(charbuff, "%2.2f %%", dashboard.efficiency); 
      display.setFont(ArialMT_Plain_16);
      display.drawString(50,45, charbuff); 
    }
    else
    {
      display.drawString(0, 48, "Not Loading  ");
      display.setFont(ArialMT_Plain_16);
      display.drawString(50,45, "           ");      
    }
    display.display();
